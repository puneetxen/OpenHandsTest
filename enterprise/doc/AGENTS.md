...
**Parent**: [enterprise](../AGENTS.md) | **Repository**: Welcome to OpenHands, a community focused on AI-driven

> Provides comprehensive documentation for the OpenHands Enterprise usage telemetry service, detailing its architecture, implementation plan, and phased roadmap.
