...
> Contains components and logic for managing Microcontroller Platform (MCP) server settings, providing user interface elements for displaying, editing, and validating server configurations.
