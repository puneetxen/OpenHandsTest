...
**Parent**: [agenthub](../AGENTS.md) | **Repository**: Welcome to OpenHands, a community focused on AI

> Implements the core `LocAgent` responsible for local code execution and tool interaction, translating large language model outputs into executable commands. It integrates a collection of AI-callable tools to facilitate code exploration and content searching.
