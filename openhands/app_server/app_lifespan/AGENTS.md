...
**Parent**: [app_server](../AGENTS.md) | **Repository**: Welcome to OpenHands, a community focused on AI-driven development.

> Orchestrates the application's startup and shutdown phases, ensuring proper initialization and cleanup. It specifically integrates database schema migration processes into the application's lifecycle using Alembic.
