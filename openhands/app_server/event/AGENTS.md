...
**Parent**: [app_server](../AGENTS.md) | **Repository**: OpenHands is a community focused on

> Provides core functionality for managing conversation events, including storage, retrieval, and streaming capabilities. Implements an extensible service layer for event handling and routing, supporting various data sources.
