...
**Parent**: [app_server](../AGENTS.md) | **Repository**: Welcome to OpenHands, a community focused on

> Provides a comprehensive system for managing and provisioning various types of secure and isolated execution environments for agents. Implements different sandbox services and their corresponding specification providers, enabling the creation, configuration, and monitoring of Docker-based, process-based, and remote sandboxes.
