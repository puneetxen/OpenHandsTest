...
> Provides core business logic for managing user conversations and calculating relevant statistics. Encapsulates operations that interact with conversation data and state.
